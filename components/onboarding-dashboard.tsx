...
const steps = [
  { day: '01', label: 'Meet your people', icon: Users },
  { day: '02', label: 'Find your rhythm', icon: Compass },
  { day: '03', label: 'Learn the domain', icon: BookOpen },
  { day: '04', label: 'Build your edge', icon: Zap },
]
